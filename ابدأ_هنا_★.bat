...
echo 🚀 تشغيل Backend...
cd /d "%~dp0backend"
start "Backend" cmd /k "echo ╔═════════════════════════════════════════════╗ && echo ║  Backend يعمل                               ║ && echo ╚═════════════════════════════════════════════╝ && echo. && echo 📍 http://localhost:3000 && echo. && echo ⚠️  لا تغلق هذه النافذة! && echo. && npm install sqlite3 && node server-sqlite.js"
