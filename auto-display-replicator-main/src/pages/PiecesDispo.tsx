...
import FamillesPiecesSectionCompact from "@/components/FamillesPiecesSectionCompact";
...
export default function PiecesDispo() {
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] overflow-x-hidden flex flex-col">
      ...
      {(parts.length > 0 || isAdmin || loading || error) && (
