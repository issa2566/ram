      ...
      <section className="text-white py-8 sm:py-10 md:py-12 lg:py-16 bg-gradient-to-b from-[#0F1724] to-[#000000] overflow-hidden">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 md:gap-10 lg:gap-12 mb-6 sm:mb-8 lg:mb-10">
            ...
            {/* Column 4: Google Map - Hidden on small mobile, smaller on tablet */}
            <div className="hidden sm:block sm:col-span-2 lg:col-span-1 text-center sm:text-left">
              <h3 className="text-base sm:text-lg md:text-xl font-semibold mb-3 sm:mb-4 text-white">
                Notre Localisation
              </h3>
              <div className="w-full h-[150px] sm:h-[160px] md:h-[180px] lg:h-[200px] rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-200 border border-white/10">
                <iframe
